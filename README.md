...
[![Version](https://img.shields.io/badge/version-2.1.0-blue.svg)](https://github.com/nkliu1772/LandLocator)
...
- 🎨 **5 種標記樣式** - 文字標籤、標準 Marker、Marker+文字、小圓點、引導線標籤
- 🔗 **引導線標籤** - 文字可拖曳移動，與地號中心保持連線，完美解決重疊問題
- 🎨 **引導線自訂** - 可調整線條粗細（1-5px）、顏色、透明度
- 🎯 **可拖曳標記** - 支援手動微調標記位置
...
- **🔗 引導線設定**（僅在使用引導線標籤樣式時有效）
  - **線條粗細**：1-5px 可調整（預設 2px）
  - **線條顏色**：深灰/灰色/淺灰/紅色/藍色（預設灰色）
  - **透明度**：0-70% 可調整，數值越高越透明（預設 70%）
